...
if DevBasha:get(CukurSource.."Basha:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevBasha:del(CukurSource.."Basha:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevBasha:get(CukurSource.."Basha:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
CukurSourceName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if CukurSourceName then 
CukurSourceNames = DevBasha:smembers(CukurSource.."Basha:Mute:Names"..msg.chat_id_) or ""
if CukurSourceNames and CukurSourceNames[1] then 
for i=1,#CukurSourceNames do 
if CukurSourceName:match("(.*)("..CukurSourceNames[i]..")(.*)") then 
...
DevBasha:set(CukurSource.."Basha:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevBasha:del(CukurSource.."Basha:Lock:MuteNames"..msg.chat_id_)
end
end
end
